...
local_model_path = "/fred/oz413/LLM/huggingface/hub/models--gpt2-xl/snapshots/15ea56dee5df4983c59b2538573817e1667135e2"
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--dataset_name",  "--dataset", type=str, default="ag_news")
    ...
    if model_type == "llama":
        ...
        tokenizer = AutoTokenizer.from_pretrained(local_model_path, add_eos_token=args.add_eos_token, 
                                          add_bos_token=args.add_bos_token, use_fast=True)
    ...
    model = AutoModelForCausalLM.from_pretrained(local_model_path, config=config, **kwargs)
    ...
    with accelerator.main_process_first():
        ...
        if args.refer:
            ...
            train_dataset = load_from_disk("/fred/oz413/LLM/ag_news/default/0.0.0/2fca38419c0e73a5")
